...
\only<3>{\includegraphics[width=0.9\textwidth]{./figures/austria3colored.pdf}}
\end{center}
...
\begin{frame}{Knowledge Propagation}
  ...
  \begin{columns}
    ...
    \begin{figure}
      ...
      \only<1>{\includegraphics[width=0.9\textwidth, trim=0 0 0 0, clip]{./figures/KP1.pdf}}
      \only<2>{\includegraphics[width=0.9\textwidth, trim=0 0 0 0, clip]{./figures/KP2.pdf}}
      \only<3>{\includegraphics[width=0.9\textwidth, trim=0 0 0 0, clip]{./figures/KP3.pdf}}
      \only<4>{\includegraphics[width=0.9\textwidth, trim=0 0 0 0, clip]{./figures/KP4.pdf}}
      \only<5>{\includegraphics[width=0.9\textwidth, trim=0 0 0 0, clip]{./figures/KP5.pdf}}
      \only<6>{\includegraphics[width=0.9\textwidth, trim=0 0 0 0, clip]{./figures/KP6.pdf}}
      \end{overlayarea}
    \end{figure}
  \end{columns}
\end{frame}
