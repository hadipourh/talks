...
\sectionheader[\huge\color{tug}\faLaptop]{Universal Bound for Data Complexity}
...
\sectionheader[\huge\color{tug}\faLaptop]{Differential Attack}
...
\sectionheader[\huge\color{tug}\faLaptop]{Linear Attack}
...
\sectionheader[\huge\color{tug}\faLaptop]{Boomerang Attack}
...
\sectionheader[\huge\color{tug}\faLightbulbO]{Differential-Linear Attacks}
...
\sectionheader[\huge\color{tug}\faLaptop]{Bit-Wise Model for Finding \\ID/ZC/Integral Distinguishers}
